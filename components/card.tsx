                ...
                <div className={`card__container js-card-opener ${open?"open":""}`}>
                    <div className={`card ${open?"open":""}`}>
                        <div className={`card__panel card__panel--front ${open?"open":""}`}>
                            <img width="400" height="600" src="https://res.cloudinary.com/dhmqojhnk/image/upload/v1689787142/fcyz09ojtzofswht9tx3.jpg"/>
                           
                         
                        </div>
                        <div className={`card__panel card__panel--inside-left ${open?"open":""}`}>

                        <img width="400" height="600" src="https://res.cloudinary.com/dhmqojhnk/image/upload/v1689787113/ojxxqkjtu1q6hi306qqg.jpg"/>
